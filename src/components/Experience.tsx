...
const experiences: ExperienceItem[] = [
  {
    ...
    duration: '1 year',
    responsibilities: [
      'Engineered backend services for a healthcare ERP covering patient records, consultations, prescriptions, and lab workflows',
      'Developed a Financial Analysis & Business Intelligence backend with balance sheet processing (XLSX/XBRL) and KPI benchmarking',
      'Designed accounting modules for inventory, purchases, invoicing, banking, and reporting with audit-friendly validations and error handling',
      'Optimized performance via ORM/query tuning, pagination, connection pooling, and structured logging; ensured reliability with 200+ unit tests',
    ],
    techStack: [
      'Python',
      'Flask',
